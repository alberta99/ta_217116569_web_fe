...
export default function FormPropsTextFields() {
  ...
  const handleChangeinput = useCallback((event) => {
    ...
    else if (event.target.name === "alamatsales")
      setAlamatsales(event.target.value);
    else if (event.target.name === "nohpsales")
      setNohpsales(event.target.value);
    else if (event.target.name === "emailsales")
      setEmailsales(event.target.value);
  }, []);
